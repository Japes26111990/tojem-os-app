...
              </Button>
                {/* Replaced H1 text with your logo image */}
...
activeLinkClass : inactiveLinkClass}`}>Dashboard</NavLink>
            <NavLink to="/stock" className={({ isActive }) => `${linkClass} ${isActive ?
activeLinkClass : inactiveLinkClass}`}>Stock Control</NavLink>
            <NavLink to="/creator" className={({ isActive }) => `${linkClass} ${isActive ?
activeLinkClass : inactiveLinkClass}`}>Job Creator</NavLink>
            <NavLink to="/tracking" className={({ isActive }) => `${linkClass} ${isActive ?
activeLinkClass : inactiveLinkClass}`}>Tracking</NavLink>
            <NavLink to="/scan" className={({ isActive }) => `${linkClass} ${isActive ?
activeLinkClass : inactiveLinkClass}`}>Scanner</NavLink>
            <NavLink to="/qc" className={({ isActive }) => `${linkClass} ${isActive ?
activeLinkClass : inactiveLinkClass}`}>QC</NavLink>
            <NavLink to="/issues" className={({ isActive }) => `${linkClass} ${isActive ?
activeLinkClass : 'text-red-400 hover:bg-red-500/20 hover:text-white'}`}>Issues</NavLink>
            <NavLink to="/performance" className={({ isActive }) => `${linkClass} ${isActive ?
activeLinkClass : inactiveLinkClass}`}>Performance</NavLink>
            <NavLink to="/settings" className={({ isActive }) => `${linkClass} ${isActive ?
activeLinkClass : inactiveLinkClass}`}>Settings</NavLink>
          </div>
        </nav>
